...
class InstructorDetector:
    ...
    def __init__(self):
        ...
        self.title_keywords = [
            'assistant professor', 'associate professor', 'senior lecturer', 'lecturer', 'adjunct professor', 'adjunct instructor', 'adjunct instructor (ph.d)', 'professor', 'phd', 'ph.d', 'Dr', 'Dr.'
        ]
        self.dept_keywords = [
